...
TEXTS = {
    'en': {
        ...
        'get_data_button': "Export Data",
        'export_success_message': "Airdrop participants data",
        'library_error_message': "The required libraries for Excel export ('pandas', 'openpyxl') are not installed. Please check the `requirements.txt` file and your Render settings."
    },
    'jp': {
        'welcome_message': (
        ...
        'admin_panel_message': "管理者パネル:",
        'get_data_button': "データをエクスポート",
        'export_success_message': "Airdrop参加者データ",
        'library_error_message': "Excelエクスポートに必要なライブラリ ('pandas', 'openpyxl') がインストールされていません。`requirements.txt`ファイルとRenderの設定を確認してください。"
    },
    'fr': {
        'welcome_message': (
        ...
        'admin_panel_message': "Panneau d'administration:",
        'get_data_button': "Exporter les données",
        'export_success_message': "Données des participants à l'Airdrop",
        'library_error_message': "Les bibliothèques requises pour l'exportation Excel ('pandas', 'openpyxl') ne sont pas installées. Veuillez vérifier le fichier `requirements.txt` et vos paramètres Render."
    },
}
