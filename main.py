...
# FIXED: Use Telegram ID for accurate admin identification
ADMIN_ID = 7578618644
...
async def send_admin_data(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user.id == ADMIN_ID:
        try:
            ...
            os.remove(file_path)
        except ImportError:await update.message.reply_text("Please install 'pandas' and 'openpyxl' to generate the Excel file.")
