...
# یک دیکشنری ساده برای ذخیره اطلاعات کاربران. در حالت واقعی باید از دیتابیس استفاده شود.
users_data = {}
referred_by = {}
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if state == 'ask_telegram_username':
        ...
        await asyncio.sleep(1) # Wait to send the next message
        ...
        # A simple fallback for other messages. Can be expanded.
        pass
