...
async def admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user.id == ADMIN_ID:
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text(get_translation(lang, "admin_panel_message"), reply_markup=reply_markup)
...
async def send_admin_data(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user.id == ADMIN_ID:
        ...
        try:
            ...
            await update.callback_query.message.reply_document(open(file_path, 'rb'), caption=get_translation(get_user_language(user.id), "export_success_message"))
            os.remove(file_path)
        except ImportError:
            await update.callback_query.message.reply_text(get_translation(get_user_language(user.id), "library_error_message"))
