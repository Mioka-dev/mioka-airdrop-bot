...
# FIXED: Normalize the admin username by removing the '@' symbol
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # FIXED: Check admin username in a case-insensitive way and normalize it
    if user.username and user.username.lstrip('@').lower() == ADMIN_USERNAME.lower():
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_username and user_username.lstrip('@').lower() == ADMIN_USERNAME.lower() and query.data != 'get_admin_data':
        return
    ...
    if query.data.startswith('lang_'):
        ...
        if user_username and user_username.lstrip('@').lower() == ADMIN_USERNAME.lower():
