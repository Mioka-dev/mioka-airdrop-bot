...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if state == 'welcoming':
        set_user_state(user_id, 'ask_telegram_username')
        await update.message.reply_text(get_translation(lang, "after_join_telegram_message"), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(get_translation(lang, "done_button"), callback_data='done_telegram')]]))
        ...
        keyboard = [
            [InlineKeyboardButton(get_translation(lang, "follow_twitter_button"), url=LINKS['twitter_page'])]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text(get_translation(lang, "after_telegram_username_message"), reply_markup=reply_markup)
        
    elif state == 'ask_twitter_follow':
        set_user_state(user_id, 'ask_twitter_retweet')
        keyboard = [
            [InlineKeyboardButton(get_translation(lang, "retweet_button"), url=LINKS['retweet_link'])]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await update.message.reply_text(get_translation(lang, "after_follow_twitter_message"), reply_markup=reply_markup)
        
    elif state == 'ask_twitter_retweet':
        set_user_state(user_id, 'ask_twitter_username_input')
